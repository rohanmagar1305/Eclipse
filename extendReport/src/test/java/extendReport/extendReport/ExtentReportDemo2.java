...
public class ExtentReportDemo2 {
	...
	public void setup()
	{
		//ExtentHtmlReporter reporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"/Reports/learn_automation2.html");
		 ExtentSparkReporter reporter=new ExtentSparkReporter("./Reports/learn_automation2.html");
